...
import { n as AstroError, G as UnknownContentCollectionError, H as RenderUndefinedEntryError, c as createComponent, u as unescapeHTML, a as renderTemplate, J as renderUniqueStylesheet, K as renderScriptElement, O as createHeadAndContent, r as renderComponent } from './astro/server_ngSGK97K.mjs';
import 'piccolore';
import * as devalue from 'devalue';
import { e as cleanSlug, P as POST_PERMALINK_PATTERN, t as trimSlash, A as APP_BLOG, C as CATEGORY_BASE, T as TAG_BASE, B as BLOG_BASE } from './permalinks_DwY3Cg8-.mjs';
...
class ImmutableDataStore {
  ...
  static async fromModule() {
    try {
      const data = await import('./_astro_data-layer-content_B2sc-hEl.mjs');
...
const __vite_import_meta_env__ = {"ASSETS_PREFIX": undefined, "BASE_URL": "/", "DEV": false, "MODE": "production", "PROD": true, "PUBLIC_API_URL": "https://superadmin-boost-1.preview.emergentagent.com", "PUBLIC_SITE_URL": "https://superadmin-boost-1.preview.emergentagent.com", "SITE": "https://marketmindai.com", "SSR": true};
...
async function updateImageReferencesInBody(html, fileName) {
  ...
  const { getImage } = await import('./_astro_assets_UbLdIS6P.mjs').then(n => n._);
...
async function renderEntry(entry) {
  ...
  if (entry.deferredRender) {
    try {
      const { default: contentModules } = await import('./content-modules_Boxqu4fN.mjs');
