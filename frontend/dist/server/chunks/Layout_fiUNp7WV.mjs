import { c as createComponent, b as addAttribute, a as renderTemplate, h as defineScriptVars, f as createAstro, r as renderComponent, F as Fragment, u as unescapeHTML, z as spreadAttributes, e as renderHead, g as renderSlot } from './astro/server_ngSGK97K.mjs';
import 'piccolore';
/* empty css                             */
import { a as getAsset, U as UI, b as getCanonical, I as I18N, S as SITE, M as METADATA } from './permalinks_DwY3Cg8-.mjs';
import 'clsx';
import { c as createSvgComponent } from './runtime_DKKRirjB.mjs';
/* empty css                           */
import merge from 'lodash.merge';
import { escape } from 'html-escaper';
import { a as getImage } from './_astro_assets_UbLdIS6P.mjs';
import { parseUrl, transformUrl } from 'unpic';

const $$CommonMeta = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`<meta charset="UTF-8"><meta name="viewport" content="width=device-width, initial-scale=1.0"><meta http-equiv="X-UA-Compatible" content="IE=edge"><!-- Resource Hints for Performance --><link rel="preconnect" href="https://fonts.googleapis.com" crossorigin><link rel="dns-prefetch" href="https://fonts.googleapis.com"><!-- Sitemap --><link rel="sitemap"${addAttribute(getAsset("/sitemap-index.xml"), "href")}><!-- Additional SEO Meta Tags --><meta name="format-detection" content="telephone=no"><meta name="theme-color" content="#ffffff" media="(prefers-color-scheme: light)"><meta name="theme-color" content="#1a202c" media="(prefers-color-scheme: dark)">`;
...
const appleTouchIcon = new Proxy({"src":"/_astro/apple-touch-icon.DHIlG7dp.png","width":180,"height":180,"format":"png"}, {
						get(target, name, receiver) {
							...
							if (name === 'fsPath') {
								return "/app/frontend/src/assets/favicons/apple-touch-icon.png";
							}
...
const $$Layout = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`<html${addAttribute(language, "lang")}${addAttribute(textDirection, "dir")} class="2xl:text-[20px]"> <head>${renderComponent($$result, "CommonMeta", $$CommonMeta, {})}${renderComponent($$result, "Favicons", $$Favicons, {})}${renderComponent($$result, "CustomStyles", $$CustomStyles, {})}${renderComponent($$result, "ApplyColorMode", $$ApplyColorMode, {})}${renderComponent($$result, "Metadata", $$Metadata, { ...metadata })}${renderComponent($$result, "SiteVerification", $$SiteVerification, {})}${renderComponent($$result, "Analytics", $$Analytics, {})}${renderComponent($$result, "StructuredData", $$StructuredData, { ...metadata })}${renderHead()}</head> <body class="antialiased text-default bg-page tracking-tight"> ${renderSlot($$result, $$slots["default"])} ${renderComponent($$result, "BasicScripts", $$BasicScripts, {})} </body></html>`;
