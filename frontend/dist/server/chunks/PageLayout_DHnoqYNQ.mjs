import { f as createAstro, c as createComponent, m as maybeRenderHead, b as addAttribute, r as renderComponent, a as renderTemplate, g as renderSlot, z as spreadAttributes, F as Fragment, u as unescapeHTML, d as renderScript } from './astro/server_ngSGK97K.mjs';
import 'piccolore';
import { $ as $$Layout } from './Layout_fiUNp7WV.mjs';
import { $ as $$Icon, a as $$Logo } from './Logo_CA0law7c.mjs';
...
const $$AuthButton = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`<!-- Auth Button Component --><!-- This script runs on every page to update the auth button and add user navigation based on login status -->${renderScript($$result, "/app/frontend/src/components/common/AuthButton.astro?astro&type=script&index=0&lang.ts")}`;
}, "/app/frontend/src/components/common/AuthButton.astro", void 0);
  ...
  actions: [
    {
      ...
      variant: "secondary",
      id: "auth-button"
      // Will be dynamically updated by client-side JS
    },
    {
      text: "Submit Tool",
      href: getPermalink("/contact"),
