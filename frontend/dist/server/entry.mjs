...
import { c as createExports, s as serverEntrypointModule } from './chunks/_@astrojs-ssr-adapter_B9dLMOzl.mjs';
import { manifest } from './manifest_CsJy1goY.mjs';
...
const _page14 = () => import('./pages/admin/sitemap.astro.mjs');
const _page15 = () => import('./pages/admin/tools.astro.mjs');
const _page16 = () => import('./pages/admin/users.astro.mjs');
const _page17 = () => import('./pages/admin.astro.mjs');
const _page18 = () => import('./pages/ai-blog-generator.astro.mjs');
const _page19 = () => import('./pages/auth/forgot-password.astro.mjs');
const _page20 = () => import('./pages/auth/login.astro.mjs');
const _page21 = () => import('./pages/auth/register.astro.mjs');
const _page22 = () => import('./pages/auth/reset-password.astro.mjs');
const _page23 = () => import('./pages/auth/verify-email.astro.mjs');
...
const _page32 = () => import('./pages/tools/compare.astro.mjs');
const _page33 = () => import('./pages/tools/_slug_.astro.mjs');
const _page34 = () => import('./pages/tools.astro.mjs');
const _page35 = () => import('./pages/user/blogs/create.astro.mjs');
const _page36 = () => import('./pages/user/blogs/edit/_id_.astro.mjs');
const _page37 = () => import('./pages/user/blogs.astro.mjs');
const _page38 = () => import('./pages/user/claimed-tools.astro.mjs');
const _page39 = () => import('./pages/user/dashboard.astro.mjs');
...
const pageMap = new Map([
    ...
    ["src/pages/admin/sitemap.astro", _page14],
    ["src/pages/admin/tools.astro", _page15],
    ["src/pages/admin/users.astro", _page16],
    ["src/pages/admin/index.astro", _page17],
    ["src/pages/ai-blog-generator.astro", _page18],
    ["src/pages/auth/forgot-password.astro", _page19],
    ["src/pages/auth/login.astro", _page20],
    ["src/pages/auth/register.astro", _page21],
    ["src/pages/auth/reset-password.astro", _page22],
    ["src/pages/auth/verify-email.astro", _page23],
    ...
    ["src/pages/tools/compare.astro", _page32],
    ["src/pages/tools/[slug].astro", _page33],
    ["src/pages/tools/index.astro", _page34],
    ["src/pages/user/blogs/create.astro", _page35],
    ["src/pages/user/blogs/edit/[id].astro", _page36],
    ["src/pages/user/blogs.astro", _page37],
    ["src/pages/user/claimed-tools.astro", _page38],
    ["src/pages/user/dashboard.astro", _page39],
