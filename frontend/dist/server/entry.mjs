...
import { c as createExports, s as serverEntrypointModule } from './chunks/_@astrojs-ssr-adapter_C9YIB76K.mjs';
import { manifest } from './manifest_BCs7WNQB.mjs';
...
const _page6 = () => import('./pages/admin/contacts.astro.mjs');
const _page7 = () => import('./pages/admin/free-tools.astro.mjs');
const _page8 = () => import('./pages/admin/newsletter.astro.mjs');
const _page9 = () => import('./pages/admin/reviews.astro.mjs');
const _page10 = () => import('./pages/admin/seo.astro.mjs');
...
const _page14 = () => import('./pages/ai-blog-generator.astro.mjs');
const _page15 = () => import('./pages/auth/forgot-password.astro.mjs');
const _page16 = () => import('./pages/auth/login.astro.mjs');
const _page17 = () => import('./pages/auth/register.astro.mjs');
const _page18 = () => import('./pages/auth/reset-password.astro.mjs');
const _page19 = () => import('./pages/auth/verify-email.astro.mjs');
const _page20 = () => import('./pages/blogs/_slug_.astro.mjs');
const _page21 = () => import('./pages/blogs.astro.mjs');
const _page22 = () => import('./pages/contact.astro.mjs');
const _page23 = () => import('./pages/free-tools.astro.mjs');
...
const _page28 = () => import('./pages/tools/compare.astro.mjs');
const _page29 = () => import('./pages/tools/_slug_.astro.mjs');
const _page30 = () => import('./pages/tools.astro.mjs');
const _page31 = () => import('./pages/user/dashboard.astro.mjs');
...
const pageMap = new Map([
    ...
    ["src/pages/admin/contacts.astro", _page6],
    ["src/pages/admin/free-tools.astro", _page7],
    ["src/pages/admin/newsletter.astro", _page8],
    ["src/pages/admin/reviews.astro", _page9],
    ["src/pages/admin/seo.astro", _page10],
    ["src/pages/admin/tools.astro", _page11],
    ["src/pages/admin/users.astro", _page12],
    ["src/pages/admin/index.astro", _page13],
    ["src/pages/ai-blog-generator.astro", _page14],
    ["src/pages/auth/forgot-password.astro", _page15],
    ["src/pages/auth/login.astro", _page16],
    ["src/pages/auth/register.astro", _page17],
    ["src/pages/auth/reset-password.astro", _page18],
    ["src/pages/auth/verify-email.astro", _page19],
    ["src/pages/blogs/[slug].astro", _page20],
    ["src/pages/blogs/index.astro", _page21],
    ["src/pages/contact.astro", _page22],
    ["src/pages/free-tools.astro", _page23],
    ["src/pages/pricing.astro", _page24],
    ["src/pages/privacy.md", _page25],
    ["src/pages/rss.xml.ts", _page26],
    ["src/pages/terms.md", _page27],
    ["src/pages/tools/compare.astro", _page28],
    ["src/pages/tools/[slug].astro", _page29],
    ["src/pages/tools/index.astro", _page30],
    ["src/pages/user/dashboard.astro", _page31],
