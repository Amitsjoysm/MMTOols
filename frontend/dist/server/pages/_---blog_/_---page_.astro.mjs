...
import { d as getStaticPathsBlogList, e as blogListRobots } from '../../chunks/blog_D2J8Pj0v.mjs';
...
` })} ${renderComponent($$result2, "BlogList", $$List, { "posts": page.data })} ${renderComponent($$result2, "Pagination", $$Pagination, { "prevUrl": page.url.prev, "nextUrl": page.url.next })} <!--
    ...
    --> </section> ` })}`;
}, "/app/frontend/src/pages/[...blog]/[...page].astro", void 0);

const $$file = "/app/frontend/src/pages/[...blog]/[...page].astro";
const $$url = "/[...blog]/[...page]";
