import{s as d}from"./api.CZvKPiQ1.js";import{r as o}from"./auth.DepAfbYU.js";o();let r=[];async function n(){await i(),x()}async function i(){try{const e=await d.seo.getOverview(),s=document.getElementById("seo-overview");s.innerHTML=`
