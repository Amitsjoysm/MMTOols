import{i as u}from"./auth.DepAfbYU.js";import{d as c,u as p}from"./api.LtktkIWz.js";u()||(window.location.href="/auth/login?redirect=/ai-blog-generator");let d=null;async function m(){const o=document.getElementById("topics-list");try{const t=await c.getBlogTopics();t.suggested_topics&&t.suggested_topics.length>0?(o.innerHTML=t.suggested_topics.map(n=>`
          <button 
