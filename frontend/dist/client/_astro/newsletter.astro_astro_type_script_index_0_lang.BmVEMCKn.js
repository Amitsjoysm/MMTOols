import{a as l}from"./api.ChDfilu5.js";import{r as g}from"./auth.DepAfbYU.js";g();let e=0;const n=20;async function m(){await u(),await r(),x()}async function u(){try{const t=await l.getNewsletterStats(),d=document.getElementById("stats-grid");d.innerHTML=`
