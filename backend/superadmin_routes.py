...
from models import User, Tool, Blog, Category, Review, SeoPage, tool_categories, NewsletterSubscription, ContactSubmission, SiteSettings, SitemapEntry
...
async def get_tool_by_id(
    ...
    tool_data = {
        ...
        "features": tool.features if tool.features else [],
        "pros": tool.pros if tool.pros else [],
        "cons": tool.cons if tool.cons else [],
        "rating": tool.rating,
        "review_count": tool.review_count,
        ...
        "category_ids": [cat.id for cat in tool.categories] if tool.categories else [],
        "company_location": tool.company_location,
        "started_on": tool.started_on,
        "about": tool.about,
        "company_founders": tool.company_founders if tool.company_founders else [],
        ...
        "claimed_by_user_id": tool.claimed_by_user_id,
