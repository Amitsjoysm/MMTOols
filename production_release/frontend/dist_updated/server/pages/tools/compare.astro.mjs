...
</p> </div> <!-- Tool Selection --> <div id="tool-selector" class="mb-8"> <div class="bg-white dark:bg-gray-800 rounded-lg shadow-md p-6"> <h2 class="text-xl font-bold text-gray-900 dark:text-white mb-4">Select Tools to Compare (max 5)</h2> <!-- Search for tools --> <div class="mb-4"> <input type="text" id="tool-search" placeholder="Search for tools to add..." class="w-full px-4 py-3 rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:ring-2 focus:ring-blue-500 focus:border-transparent" data-testid="tool-search-input"> </div> <!-- Search results --> <div id="search-results" class="hidden mb-4 max-h-60 overflow-y-auto space-y-2" data-testid="search-results"></div> <!-- Selected tools --> <div id="selected-tools" class="flex flex-wrap gap-2 min-h-12" data-testid="selected-tools"></div> </div> </div> <!-- Loading State --> <div id="loading" class="hidden text-center py-12"> <div class="inline-block animate-spin rounded-full h-12 w-12 border-b-2 border-blue-600"></div> <p class="mt-4 text-gray-600 dark:text-gray-400">Loading comparison...</p> </div> <!-- AI Comparison Results --> <div id="ai-comparison-section" class="hidden mt-8 bg-gradient-to-r from-purple-50 to-blue-50 dark:from-purple-900/20 dark:to-blue-900/20 rounded-xl p-6"> <div class="flex items-center justify-between mb-4"> <h3 class="text-xl font-bold text-gray-900 dark:text-white flex items-center gap-2"> <span class="text-2xl">🤖</span> AI Analysis
</h3> <span class="px-3 py-1 bg-purple-100 dark:bg-purple-800 text-purple-800 dark:text-purple-200 text-sm rounded-full">
Powered by AI
</span> </div> <div id="ai-comparison-content" class="prose dark:prose-invert max-w-none"> <!-- AI analysis will be inserted here --> </div> </div> <!-- Comparison Table --> <div id="comparison-container" class="hidden" data-testid="comparison-table"> <div class="flex items-center justify-between mb-4"> <h3 class="text-xl font-bold text-gray-900 dark:text-white">Side-by-Side Comparison</h3> <button id="ai-compare-btn" class="px-4 py-2 bg-gradient-to-r from-purple-600 to-blue-600 text-white rounded-lg hover:from-purple-700 hover:to-blue-700 transition-all font-medium flex items-center gap-2 disabled:opacity-50"> <span>🤖</span> Get AI Analysis
</button> </div> <div class="overflow-x-auto"> <table class="w-full bg-white dark:bg-gray-800 rounded-lg shadow-md"> <thead> <tr id="comparison-header" class="border-b border-gray-200 dark:border-gray-700"> <th class="p-4 text-left text-gray-900 dark:text-white font-bold sticky left-0 bg-white dark:bg-gray-800">Feature</th> </tr> </thead> <tbody id="comparison-body"> <!-- Comparison rows will be added here --> </tbody> </table> </div> </div> <!-- Empty State --> <div id="empty-state" class="text-center py-12"> <p class="text-xl text-gray-600 dark:text-gray-400 mb-4">
