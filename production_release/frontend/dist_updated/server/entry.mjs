...
import { manifest } from './manifest_gxVnWq1l.mjs';
...
const _page34 = () => import('./pages/tools/recommend.astro.mjs');
const _page35 = () => import('./pages/tools/_slug_.astro.mjs');
const _page36 = () => import('./pages/tools.astro.mjs');
const _page37 = () => import('./pages/user/blogs/create.astro.mjs');
const _page38 = () => import('./pages/user/blogs/edit/_id_.astro.mjs');
const _page39 = () => import('./pages/user/blogs.astro.mjs');
const _page40 = () => import('./pages/user/claimed-tools.astro.mjs');
const _page41 = () => import('./pages/user/dashboard.astro.mjs');
...
const pageMap = new Map([
    ...
    ["src/pages/tools/recommend.astro", _page34],
    ["src/pages/tools/[slug].astro", _page35],
    ["src/pages/tools/index.astro", _page36],
    ["src/pages/user/blogs/create.astro", _page37],
    ["src/pages/user/blogs/edit/[id].astro", _page38],
    ["src/pages/user/blogs.astro", _page39],
    ["src/pages/user/claimed-tools.astro", _page40],
    ["src/pages/user/dashboard.astro", _page41],
