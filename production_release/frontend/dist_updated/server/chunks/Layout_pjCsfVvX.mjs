import { c as createComponent, b as addAttribute, a as renderTemplate, h as defineScriptVars, f as createAstro, r as renderComponent, F as Fragment, u as unescapeHTML, B as spreadAttributes, g as renderSlot, e as renderHead } from './astro/server_CZk8NOd-.mjs';
import 'piccolore';
/* empty css                             */
import { U as UI, a as getCanonical, I as I18N, S as SITE, M as METADATA } from './permalinks_CkvIL3vS.mjs';
import 'clsx';
import { $ as $$Favicons } from './Favicons_zx64ruqZ.mjs';
/* empty css                           */
import merge from 'lodash.merge';
import { escape } from 'html-escaper';
import { a as getImage } from './_astro_assets_dz_UpwIN.mjs';
import { parseUrl, transformUrl } from 'unpic';

const $$CommonMeta = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`<meta charset="UTF-8"><meta name="viewport" content="width=device-width, initial-scale=1.0"><meta http-equiv="X-UA-Compatible" content="IE=edge"><!-- Resource Hints for Performance --><link rel="preconnect" href="https://fonts.googleapis.com" crossorigin><link rel="dns-prefetch" href="https://fonts.googleapis.com"><link rel="preconnect" href="https://fonts.gstatic.com" crossorigin><!-- Sitemap discovery --><link rel="sitemap" href="/sitemap-index.xml"><link rel="sitemap" type="application/xml" href="/sitemap-dynamic.xml"><!-- Mobile/PWA --><meta name="format-detection" content="telephone=no"><meta name="theme-color" content="#2563eb" media="(prefers-color-scheme: light)"><meta name="theme-color" content="#1a202c" media="(prefers-color-scheme: dark)"><meta name="mobile-web-app-capable" content="yes"><meta name="apple-mobile-web-app-capable" content="yes"><meta name="apple-mobile-web-app-status-bar-style" content="default"><!-- SEO: Site-wide author and publisher --><meta name="author" content="MarketMindAI"><meta name="publisher" content="MarketMindAI"><meta name="copyright"${addAttribute(`\xA9 ${(/* @__PURE__ */ new Date()).getFullYear()} MarketMindAI`, "content")}><meta name="language" content="en-US"><meta name="revisit-after" content="7 days"><meta name="rating" content="general">`;
}, "/app/frontend/src/components/common/CommonMeta.astro", void 0);
...
}, "/app/frontend/src/components/CustomStyles.astro", void 0);
...
}, "/app/frontend/src/components/common/ApplyColorMode.astro", void 0);
...
}, "/app/frontend/node_modules/@astrolib/seo/src/AstroSeo.astro", void 0);
...
const load = async function() {
  let images = void 0;
  try {
    images = /* #__PURE__ */ Object.assign({"/src/assets/images/app-store.png": () => import('./app-store_D6M96Tno.mjs'),"/src/assets/images/default.png": () => import('./default_CkzS1j4p.mjs'),"/src/assets/images/google-play.png": () => import('./google-play_C8W8iqsi.mjs'),"/src/assets/images/hero-image.png": () => import('./hero-image_Bo9Dp5LC.mjs')});
  } catch (error) {
  }
  return images;
};
      ...
      if (image?.url) {
        ...
        if (typeof resolvedImage === "string" && (resolvedImage.startsWith("http://") || resolvedImage.startsWith("https://")) && isUnpicCompatible(resolvedImage)) {
          ...
          if (typeof resolvedImage !== "string") {
            const dimensions = resolvedImage?.width <= defaultWidth ? [resolvedImage?.width, resolvedImage?.height] : [defaultWidth, defaultHeight];
...
const $$Metadata = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "AstroSeo", $$AstroSeo, { ...{ ...seoProps, openGraph: await adaptOpenGraphImages(seoProps?.openGraph, Astro2.site) } })} <!-- Additional SEO and Performance Meta Tags --> <meta name="author"${addAttribute(SITE?.name, "content")}> <link rel="canonical"${addAttribute(canonical, "href")}> ${description && renderTemplate`<meta name="description"${addAttribute(description, "content")}>`} <meta name="generator"${addAttribute(Astro2.generator, "content")}> <!-- Geo Tags (optional - can be customized based on target audience) --> <meta name="geo.region" content="US"> <meta name="geo.position" content="0;0"> <meta name="ICBM" content="0, 0">`;
}, "/app/frontend/src/components/common/Metadata.astro", void 0);

const $$SiteVerification = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${SITE.googleSiteVerificationId}`;
}, "/app/frontend/src/components/common/SiteVerification.astro", void 0);
...
}, "/app/frontend/node_modules/@astrolib/analytics/src/GoogleAnalytics.astro", void 0);

const $$Analytics = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${null}`;
}, "/app/frontend/src/components/common/Analytics.astro", void 0);
    ...
    "@graph": [
      {
        ...
        sameAs: [
          `https://twitter.com/${METADATA.twitter.site.replace("@", "")}` 
        ].filter(Boolean)
      },
      {
        "@type": "WebSite",
...
}, "/app/frontend/src/components/common/StructuredData.astro", void 0);
...
const $$Layout = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`<html${addAttribute(language, "lang")}${addAttribute(textDirection, "dir")} class="2xl:text-[20px]"> <head>${renderComponent($$result, "CommonMeta", $$CommonMeta, {})}${renderComponent($$result, "Favicons", $$Favicons, {})}${renderComponent($$result, "CustomStyles", $$CustomStyles, {})}${renderComponent($$result, "ApplyColorMode", $$ApplyColorMode, {})}${renderComponent($$result, "Metadata", $$Metadata, { ...metadata })}${renderComponent($$result, "SiteVerification", $$SiteVerification, {})}${renderComponent($$result, "Analytics", $$Analytics, {})}${renderComponent($$result, "StructuredData", $$StructuredData, { ...metadata })}${renderSlot($$result, $$slots["head"])}${renderHead()}</head> <body class="antialiased text-default bg-page tracking-tight"> ${renderSlot($$result, $$slots["default"])} ${renderComponent($$result, "BasicScripts", $$BasicScripts, {})} </body></html>`;
}, "/app/frontend/src/layouts/Layout.astro", void 0);
