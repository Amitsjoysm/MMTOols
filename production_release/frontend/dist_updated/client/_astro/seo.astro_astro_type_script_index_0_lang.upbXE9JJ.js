import{s as d}from"./api.9IHSeoxB.js";import{r as o}from"./auth.-1gIpQ0w.js";o();let r=[];async function n(){await i(),x()}async function i(){try{const e=await d.seo.getOverview(),s=document.getElementById("seo-overview");s.innerHTML=`
