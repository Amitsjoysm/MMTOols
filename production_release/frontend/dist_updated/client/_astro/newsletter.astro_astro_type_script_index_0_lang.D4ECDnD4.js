import{a as l}from"./api.9IHSeoxB.js";import{r as g}from"./auth.-1gIpQ0w.js";g();let e=0;const n=20;async function m(){await u(),await r(),x()}async function u(){try{const t=await l.getNewsletterStats(),d=document.getElementById("stats-grid");d.innerHTML=`
